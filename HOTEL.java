...
public class HOTEL {
    public static void main(String[] args) throws InterruptedException {
        ...
        int opcion, opcion2, habitacion_doble = 8, habitacion_individual = 2, habitaciones_totales = 10, billete500 = 0,
        ...
        String nombre_completo = "", usuarioAdmin = "admin", contraseniaSegura = "1234", contraseniaIngresada = "",
        ...
        System.out.println("""
                 _   _ _____ _____ _____ _       _____ _____ _   _______  ___ ______\s
                | | | |  _  |_   _|  ___| |     /  __ \\_   _| | | |  _  \\/ _ \\|  _  \\
                | |_| | | | | | | | |__ | |     | /  \\/ | | | | | | | | / /_\\ \\ | | |
                |  _  | | | | | | |  __|| |     | |     | | | | | | | | |  _  | | | |
                | | | \\ \\_/ / | | | |___| |____ | \\__/\\_| |_| |_| | |/ /| | | | |/ /\s
                \\_| |_/\\___/  \\_/ \\____/\\_____/  \\____/\\___/ \\___/|___/ \\_| |_/___/ \s
                                                                                    \s
                                                                                    \s
                ______ _____  ___  ___  ___  ______ _____ _____ _____               \s
                |  _  \\  ___| |  \\/  | / _ \\ | ___ \\_   _|  _  /  ___|              \s
                | | | | |__   | .  . |/ /_\\ \\| |_/ / | | | | | \\ `--.               \s
                | | | |  __|  | |\\/| ||  _  ||    /  | | | | | |`--. \\              \s
                | |/ /| |___  | |  | || | | || |\\ \\  | | \\ \\_/ /\\__/ /              \s
                |___/ \\____/  \\_|  |_/\\_| |_/\\_| \\_| \\_/  \\___/\\____/               \s                                
                """);
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 1:
                    System.out.println("VISTA DE HABITACIONES");
                    System.out.println("Habitaciones totales disponibles: " + habitaciones_totales);
                    System.out.println("Habitaciones dobles disponibles: " + habitacion_doble);
                    System.out.println("habitaciones individuales disponibles: " + habitacion_individual);
                            ...
                            if (habitacion_individual == 0) {
                                ...
                                switch (opcionReserva) {
                                    case 1:
                                        ...
                                        habitacion_doble--;
                                        habitaciones_totales = habitacion_doble + habitacion_individual;

                                        System.out.println("Has reservado con existo.");
                                        Thread.sleep(1000);
                                        break;
                ...
                case 3:
                    ...
                    System.out.println("""
                            Compañia: Hotel ciudad
                                         ...
                                         Martos
                            """);
                    System.out.println("Dirección: C. Molino Medel, 93, 23600 Martos, Jaén");
                    ...
                    //Para monstrar solo las manodas y billetes que se dan en el cambio
                ...
                case 4:
                    ...
                    do {
                        ...
                        if (!(usuarioIngresado.equals(usuarioAdmin) && contraseniaIngresada.equals(contraseniaIngresada))) {
                    ...
                    //check
                    if (usuarioAdmin.equals(usuarioIngresado) && contraseniaSegura.equals(contraseniaIngresada)) {
                        System.out.println("inicio de sesion exitosos");

                        //Caundo se complete de manera exitosa el login saldra el menu de admin
                        System.out.println("""
                                *************************
